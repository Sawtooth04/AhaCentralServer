...
const CustomersHeading = ({ renameCustomer, changePasswordCustomer, deleteCustomer, selectedCustomers }) => {
    return (
        <h1 className={styles.customersHeading}>
            ...
            <FilesButton src={'assets/icons/password.png'} hint={"Сменить пароль"} onClick={changePasswordCustomer} isActive={selectedCustomers.length === 1}/>
